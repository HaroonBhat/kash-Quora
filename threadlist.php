    ...
    <div class="container my-4 text-center">
        <div class="jumbotron">
            ...
            <p><pre>
                ...
                4. Do not cross post questions</pre></p>
    ...
    <div class="container mb-4">
        ...
        <form action=" ' .  $_SERVER['REQUEST_URI'] . ' " method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" aria-describedby="emailHelp" required="true">
        ...
        echo "
        <h1 class='py-2 mb-4 text-center'>Start a Discussion</h1>
         <p class= 'text-center display-4 '>You need to be logged in to start a Discussion </p>";
    }
    ?>
    ...
    <div class="container mt-4" id="ques">
        ...
        if ($noresult) {
            echo '<div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                <p class="display-2">No Threads Found</p>
